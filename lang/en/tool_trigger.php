...
$string['assigncourseactionstepname'] = 'Assign course';
$string['assigncourseactionstepdec'] = 'A step that allows you to assign training to a user';
...
$string['invalidcourseid'] = 'The workflow import file is not valid with this version of the plugin';
$string['invalidjson'] = 'The workflow import file contains invalid JSON and could not be imported';
$string['invaliduserid'] = 'The workflow import file is not valid with this version of the plugin';
